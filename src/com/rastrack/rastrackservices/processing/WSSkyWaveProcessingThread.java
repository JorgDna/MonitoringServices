...
import static com.rastrack.rastrackservices.processing.WSWidtechProcessingThread.addThread;
import static com.rastrack.rastrackservices.processing.WSWidtechProcessingThread.removeThread;
 ...
 * @author usuario
 */
public class WSSkyWaveProcessingThread extends Thread {
    ...
    public WSSkyWaveProcessingThread(String name, int servId, boolean parameterized) {
        super(name);
    ...
    public void run() {
        ...
        removeThread();
        if (threadsNumber <= 0) {
            LOGGER.info("All of Threads for WS SkyWave service have ended");
        }
    }
